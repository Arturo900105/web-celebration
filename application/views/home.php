...
<html lang="en">
	...
	<body>
			...
			<div class="container">
				...
				<div class="row align-items-center justify-content-center pt-5 pb-4
					...
					<div class="col-auto d-none d-lg-block d-xl-none">
						<div class="rounded-circle bg-blue-celebration p-2">
							<img width="150" class="m-4" src="<?php echo base_url('assets/img/Logo_Celebration.svg'); ?>" alt="Grupo Celebration">
						</div>
					</div>
					<div class="col-auto d-none d-md-block d-lg-none">
						<div class="rounded-circle bg-blue-celebration p-2">
							<img width="120" class="m-4" src="<?php echo base_url('assets/img/Logo_Celebration.svg'); ?>" alt="Grupo Celebration">
						</div>
					</div>
				</div>
				<div class="row align-items-center justify-content-right pt-5 pb-4">
					<i class="d-flex
							  align-items-center
		...
		<div id="about" class="container-fluid txt-blue-celebration pt-5 pb-5">
			...
			<div class="container pt-4 pb-4">
				<div class="row align-items-center justify-content-center">
					<h1 class="text-center w-100 d-none d-sm-block font-champagne-bold">Nosotros somos...</h1>
					<h3 class="text-center w-100 d-sm-none font-champagne-bold">Nosotros somos...</h3>
					<p class="text-center w-75 d-none d-lg-block mt-3">
						"Una institucion que organiza y realiza banquetes para cualquier tipo de evento.
						Congresos tanto nacionales como internacionales. Tenemos el privilegio de operar en puntos
						relevantes de la Ciudad de México. Igual organizamos eventos priados en Hoteles,
						Recintos Históricos y las mismas Instalaciones del Cliente."
					</p>
		...
		<div id="service" class="container-fluid bg-blue-celebration text-white pt-5 pb-5">
			<div class="container pt-4 pb-4">
				<div class="row align-items-center justify-content-center">
					<h1 class="text-center w-100 d-none d-sm-block font-champagne-bold">Servicios</h1>
					<h3 class="text-center w-100 d-sm-none font-champagne-bold">Servicios</h3>
					<p class="text-center w-75 d-none d-lg-block mt-3">
						"Contamos con personal perfectamente capacitado para realizar de sus eventos un
						éxito tanto en las instalaciones del cliente como en el lugar que deseen."
					</p>
					<p class="text-center w-100 d-lg-none mt-3">
						"Contamos con personal perfectamente capacitado para realizar de sus eventos un
						éxito tanto en las instalaciones del cliente como en el lugar que deseen."
			...
			<div class="row justify-content-center pt-4">
				<div class="col-xs-12 col-sm-6 col-md-4 p-3 mt-1 p-relative text-center">
					...
					<div class="service-title mt-4">
						<h5>Cocina</h5>
						<p class="text-center desc">
							Contamos con chefs de alto nivel, equipo de banquetes,equipo de cocina,
							meseros y conseguimos cualquier alimento o platillo que desee.
						</p>
					</div>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-4 p-3 mt-1 p-relative text-center">
					...
					<div class="service-title mt-4">
						<h5>Profesionales</h5>
						<p class="text-center desc">
							Si necesita algún profesional único para su evento, nosotros lo conseguimos.
							Contamos con prestigiados Músicos, Cómicos, Traductores, Valet Parking, Seguridad,
							Decoradores, Edecanes y mucho más.
						</p>
					</div>
				</div>
				<div class="col-xs-12 col-sm-6 col-md-4 p-3 mt-1 p-relative text-center">
					...
					<div class="service-title mt-4">
						...
						<p class="text-center desc">
							Cualquier tipo de decoración única para su evento o para usted. Equipos
							profesionales en iluminación y sonido, arreglos florales, equipos de viaje y mucho
							más.
						</p>
					</div>
				</div>
		...
		<div id="team" class="container-fluid txt-blue-celebration pt-5 pb-5">
			<div class="container pt-4 pb-4">
				<div class="row align-items-center justify-content-center">
					...
					<h3 class="text-center w-100 d-sm-none font-champagne-bold">Trabajamos con</h3>
					<p class="text-center w-75 d-none d-lg-block mt-3">
						"Contamos con experiencia de más de 6 años en el medio de la realización de eventos
						desde 10 hasta 4000 personas con una capacidad de realización de eventos simultáneos."
					</p>
					<p class="text-center w-100 d-lg-none mt-3">
						"Contamos con experiencia de más de 6 años en el medio de la realización de eventos
						desde 10 hasta 4000 personas con una capacidad de realización de eventos simultáneos."
			...
			<div class="row align-items-center justify-content-center pt-4 d-none d-xl-flex text-white text-center">
				<div class="rounded-circle sq-130 bg-gray-celebration m-3 d-flex align-items-center justify-content-center p-2">
					Afore Banamex
				</div>
				<div class="rounded-circle sq-130 bg-light-gray-celebration m-3 d-flex align-items-center justify-content-center p-2">
					Banco de México
				</div>
				<div class="rounded-circle sq-130 bg-blue-celebration m-3 d-flex align-items-center justify-content-center p-2">
					ADO
				</div>
				<div class="rounded-circle sq-130 bg-light-gray-celebration m-3 d-flex align-items-center justify-content-center p-2">
					Inbursa
			...
			<div class="row align-items-center justify-content-center pt-4 d-none d-md-flex d-lg-none text-white text-center">
				...
				<div class="rounded-circle sq-80 bg-light-gray-celebration m-2 d-flex align-items-center justify-content-center p-2">
					Banco de México
				</div>
				<div class="rounded-circle sq-80 bg-blue-celebration m-2 d-flex align-items-center justify-content-center p-2">
					ADO
				</div>
				<div class="rounded-circle sq-80 bg-light-gray-celebration m-2 d-flex align-items-center justify-content-center p-2">
					Inbursa
		...
		<div id="contact" class="container-fluid bg-blue-gray-celebration text-white pt-5 pb-5">
			<div class="container pt-4 pb-4">
				<div class="row align-items-center justify-content-center">
					...
					<p class="text-center w-75 d-none d-lg-block mt-3">
						"¿Necesitas una cotización? ¿Quieres saber si tenemos el producto que deseas?
						Escribenos un email o llámanos y con gusto atenderemos a todas tus dudas."
					</p>
					<p class="text-center w-100 d-lg-none mt-3">
						"¿Necesitas una cotización? ¿Quieres saber si tenemos el producto que deseas?
						Escribenos un email o llámanos y con gusto atenderemos a todas tus dudas."
