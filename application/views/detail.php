...
<html lang="en">
	...
	<body>
		...
		<div id="img-carousel" class="container-fluid p-3 p-sm-4 p-lg-5 mt-4 mt-sm-0">
			<div class="carrusel">
				<div class="file_1 d-flex">
					<div class="col_1 h-100 cols d-flex align-items-center justify-content-center font-signpainter text-capitalize">
                        <?php echo $imgSet; ?>
					</div>
					<div class="col_2 h-100 cols"></div>
					<div class="col_3 h-100 cols"></div>
					<div class="col_4 h-100 cols"></div>
					<div class="col_5 h-100 cols"></div>
				</div>
				<div class="file_2 d-flex">
					<div class="col_1 h-100 cols"></div>
					<div class="col_2 h-100 cols"></div>
					<div class="col_3 h-100 cols"></div>
					<div class="col_4 h-100 cols"></div>
					<div class="col_5 h-100 cols"></div>
                ...
                <?php if ($imgSet != 'empresariales') { ?>
					<div class="col-sm-9 col-md-2">
						<div class="p-3 m-2 p-relative text-center bg-blue-celebration">
							<a href="<?php echo base_url('servicio/empresariales'); ?>" class="ml-auto mr-auto d-flex align-items-center justify-content-center text-white sq-50 bg-light rounded-circle">
                ...
                <?php if ($imgSet != 'sociales') { ?>
					<div class="col-sm-9 col-md-2">
						<div class="p-3 m-2 p-relative text-center bg-green-celebration">
							<a href="<?php echo base_url('servicio/sociales'); ?>" class="ml-auto mr-auto d-flex align-items-center justify-content-center text-white sq-50 bg-light rounded-circle">
                ...
                <?php if ($imgSet != 'privados') { ?>
					<div class="col-sm-9 col-md-2">
						<div class="p-3 m-2 p-relative text-center bg-red-celebration">
							<a href="<?php echo base_url('servicio/privados'); ?>" class="ml-auto mr-auto d-flex align-items-center justify-content-center text-white sq-50 bg-light rounded-circle">
                ...
                <?php if ($imgSet != 'cocina') { ?>
					<div class="col-sm-9 col-md-2">
						<div class="p-3 m-2 p-relative text-center bg-blue-sky-celebration">
							<a href="<?php echo base_url('servicio/cocina'); ?>" class="ml-auto mr-auto d-flex align-items-center justify-content-center text-white sq-50 bg-light rounded-circle">
                ...
                <?php if ($imgSet != 'profesionales') { ?>
					<div class="col-sm-9 col-md-2">
						<div class="p-3 m-2 p-relative text-center bg-purple-celebration">
							<a href="<?php echo base_url('servicio/profesionales'); ?>" class="ml-auto mr-auto d-flex align-items-center justify-content-center text-white sq-50 bg-light rounded-circle">
                ...
                <?php if ($imgSet != 'decoracion') { ?>
					<div class="col-sm-9 col-md-2">
						<div class="p-3 m-2 p-relative text-center bg-blue-gray-celebration">
							<a href="<?php echo base_url('servicio/decoracion'); ?>" class="ml-auto mr-auto d-flex align-items-center justify-content-center text-white sq-50 bg-light rounded-circle">
						...
						<div class="service-title mt-3">
							...
							<p class="text-center description">
								A veces solo necesitas un pequeño detalle para la perfección. Nosotros te lo conseguimos, uno o más.
							</p>
						</div>
					</div>
                <?php } ?>
